...
import 'material_intake_log_page_model.dart';
export 'material_intake_log_page_model.dart';

class MaterialIntakeLogPageWidget extends StatefulWidget {
  const MaterialIntakeLogPageWidget({super.key});

  @override
  _MaterialIntakeLogPageWidgetState createState() =>
      _MaterialIntakeLogPageWidgetState();
}

class _MaterialIntakeLogPageWidgetState
    extends State<MaterialIntakeLogPageWidget> {
  late MaterialIntakeLogPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MaterialIntakeLogPageModel());
                                      ...
                                      Padding(
                                        ...
                                        child: FlutterFlowDropDown<String>(
                                          ...
                                          onChanged: (val) async {
                                            ...
                                            setState(() {
                                              FFAppState().milAddLineButtonTxt =
                                                  'Add Order Line';
                                            });
                                          },
                                          width: 200.0,
                                  ...
                                  children: [
                                    Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          0.0, 8.0, 0.0, 0.0),
                                      child: Text(
                                        'Yet to receive quantity : 100 Nos ',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Readex Pro',
